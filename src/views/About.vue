  ...
  <keep-alive>
    <div class="container">
      ...
      <div class="blog">
        ...
        <p>
          前台仓库地址：<a
            href="https://gitee.com/wan-songtao/blog"
            target="blog"
            >https://gitee.com/wan-songtao/blog</a
          >
        </p>
        <p>
          管理端仓库地址：<a
            href="https://gitee.com/wan-songtao/blog-admin"
            target="blogadmin"
            >https://gitee.com/wan-songtao/blog-admin</a
          >
        </p>
        <p>
          后端代码仓库地址：<a
            href="https://gitee.com/wan-songtao/blogserve"
            target="blogserve"
            >https://gitee.com/wan-songtao/blogserve</a
          >
        </p>
      </div>
    </div>
